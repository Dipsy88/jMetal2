 ...
 * @throws JMException 
  ...
  //  variable_ = type_.createRandomVariables(problem.numberOfVariables_) ; 
  ...
  static public Solution getNewSolution(Problem problem) throws ClassNotFoundException, JMException {
